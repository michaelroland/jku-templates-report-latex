...
\usepackage{csquotes}
\usepackage[backend=biber,citestyle=numeric,sortcites=true,style=ACM-Reference-Format]{biblatex}
...
%% Command \author{name}: sets the author's name; use \prefix{} and \suffix{} to add academic titles and suffixes
\author{\prefix{DI} Firstname~Lastname \suffix{BSc}}
...
%% And also insert the declaration page that is mandatory for theses:
\makedeclaration
%% 
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
